...
# Lab 06
# Lab Section: 
# Sources, people worked with, help given to: Ben(TA), Beau Browning(my father), Google
...
for item in sorted(random_string):
    if item not in randostring_count:
            randostring_count[item] = 0
    randostring_count[item] += 1
          
# Output each letter and its corresponding occurrence in alphabetical order     
# **Done with sorted(random_string) above since we do not need the letters in non-alphabetical order**

print(randostring_count)
print(f"The sum of these values is: {sum(randostring_count.values())}")
print("*"*75) #Spacer
# Output which letter occurred the most
letter_most = max(randostring_count, key = randostring_count.get)
print(letter_most)
# Output which letter occurred the least 
letter_least = min(randostring_count, key = randostring_count.get)
print(letter_least)
# Output what the percentage of the string each character is, again in alphabetical 
# **Already sorted above
randostring_percent = {}

for key, value in randostring_count.items():
    percentage = (value / 2500) * 100
    randostring_percent[key] = percentage

print(randostring_percent)
print(f"The sum of these percentages is: {sum(randostring_percent.values())}%") 
#Tips and trick:
...
print("*"*75) #Spacer
full_dict = {}
full_dict["Counts"] = randostring_count
full_dict["Percentages"] = randostring_percent

#full_dict.append(randostring_count)
#full_dict.append(randostring_percent)
...
# Output which letter occurred the most 
print(f"The letter that occurred the most is: {letter_most} ")
print("*"*75) #Spacer

# Output which letter occurred the least 
print(f"The letter that occurred the least is: {letter_least}")